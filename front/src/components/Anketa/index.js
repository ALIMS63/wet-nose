    ...
    return (
        <div className='container-form'>
            ...
            <div className='img-div'>
              <div>
                  <label for='6'>
                  <input className='radio' style={{visibility: 'hidden'}} id='6' value='0-1' onClick={handleActive} name='3' type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}  src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>маленького</div>
                  </label>
                </div>
                <div>
                  <label for='7'>
                  <input className='radio' style={{visibility: 'hidden'}} id='7' name='3' value='3-7' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>взрослого</div>
                  </label>
              </div>
            ...
            <div className='img-div'>
              <div>
                  <label for='9'>
                  <input className='radio' style={{visibility: 'hidden'}} id='9' value='dog' onClick={handleActive} name='5' type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}  src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>квартира</div>
                  </label>
                </div>
                <div>
                  <label for='10'>
                  <input className='radio' style={{visibility: 'hidden'}} id='10' name='5' value='cat' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>дом</div>
                  </label>
              </div>
                <div>
                  <label for='11'>
                  <input className='radio' style={{visibility: 'hidden'}} id='11' name='5' value='cat' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
            ...
            <div className='img-div'>
              <div>
                  <label for='12'>
                  <input className='radio' style={{visibility: 'hidden'}} id='12' value='dog' onClick={handleActive} name='5' type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}  src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>маленькое</div>
                  </label>
                </div>
                <div>
                  <label for='13'>
                  <input className='radio' style={{visibility: 'hidden'}} id='13' name='5' value='cat' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>среднее</div>
                  </label>
              </div>
                <div>
                  <label for='14'>
                  <input className='radio' style={{visibility: 'hidden'}} id='14' name='5' value='cat' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>большое</div>
                  </label>
              </div>
            ...
            <div className='img-div'>
              <div>
                  <label for='15'>
                  <input className='radio' style={{visibility: 'hidden'}} id='15' value='dog' onClick={handleActive} name='5' type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}  src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>есть</div>
                  </label>
                </div>
                <div>
                  <label for='16'>
                  <input className='radio' style={{visibility: 'hidden'}} id='16' name='5' value='cat' onClick={handleActive} type='radio'/>
                  <img className={active? 'img-anceta' : 'img-anceta active'}   src='http://img1.joyreactor.cc/pics/post/anon-%D0%9A%D0%B0%D1%80%D1%82%D0%B8%D0%BD%D0%BA%D0%B0-2191131.jpeg' />
                  <div>нет</div>
                  </label>
              </div>
